...
function Navbar() {
  ...
  return (
    <div className="bg-white mt-6 shadow-md shadow-gray-600 rounded-full py-[12px] px-[23px]">
      ...
      {isSidebarOpen && (
        <div className="md:hidden fixed inset-0 bg-gray-800 bg-opacity-75 flex flex-col items-center justify-center">
          {links.map((linkName) => (
            <a
              key={linkName}
              href={`/${linkName}`}
